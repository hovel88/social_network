...
std::vector<InMemService::Message> HttpDialogService::get_page(const std::vector<InMemService::Message>& dialog, size_t offset, size_t limit)
{
...
std::string HttpDialogService::serialize_messages(const std::vector<InMemService::Message>& dialog)
{
    nlohmann::json j{};
    if (dialog.empty()) {
