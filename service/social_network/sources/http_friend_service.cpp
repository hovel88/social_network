...
void HttpFriendService::register_endpoints(drogon::HttpAppFramework* server)
{
...
bool HttpFriendService::friend_set_id_handler(const drogon::HttpRequestPtr& req, drogon::HttpResponsePtr& res, const std::string& requested_id)
{
...
bool HttpFriendService::friend_delete_id_handler(const drogon::HttpRequestPtr& req, drogon::HttpResponsePtr& res, const std::string& requested_id)
{
    const std::string user_id = req->attributes()->get<std::string>("user_id");
